...
The first version of CellphoneDB was originally developed at the [Teichmann Lab](http://www.teichlab.org/) by Roser Vento-Tormo and Mirjana Efremova at the Wellcome Sanger Institute (Cambridge, UK). 
...
Currently, it is being further developed and supported by the [Vento-Tormo Lab](https://ventolab.org/) (CellphoneDB ≥v3).
